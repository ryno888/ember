 ...
 * @author Ryno Van Zyl
 */
class tag extends \Kwerqy\Ember\com\ui\intf\component {
	//--------------------------------------------------------------------------------
	// fields
	//--------------------------------------------------------------------------------
	...
	protected function tag($tag, $options = []) {
		// options
  		...
  		$html = $options["*"];
  		if($html && is_callable($html) && !is_string($html)){
  		    $options["*"] = call_user_func($html);
        }

//		// event: !enter
//		if ($options["!enter"] && $options["@id"]) {
//			// submit form on enter
//			if ($options["!enter"] === true && \Kwerqy\Ember\com\ui\ui\helper::$current_form && \Kwerqy\Ember\com\ui\ui\helper::$current_form->submit_button_id) {
//				$submit_button_id = \Kwerqy\Ember\com\ui\ui\helper::$current_form->submit_button_id;
...
//			\Kwerqy\Ember\com\ui\ui::make()->tooltip();
//		}
