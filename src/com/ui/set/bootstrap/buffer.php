 ...
 * @author Ryno Van Zyl
 */
class buffer extends \Kwerqy\Ember\com\ui\intf\component {
	//--------------------------------------------------------------------------------
	// fields
	//--------------------------------------------------------------------------------
	/**
	...
	public function __call($name, $arguments) {
		...
		$this->add(call_user_func_array([\Kwerqy\Ember\com\ui\ui::make()->tag(), $name], $arguments));

		// check if tag was left open
		$last_detail = \Kwerqy\Ember\com\ui\ui::make()->tag()->get_last_detail();
	 ...
	 *
	 * @return \Kwerqy\Ember\com\ui\ui\intf\buffer
	 */
	public function close($tag = false) {
		...
		for ($i = 0; $i < $count; $i++) {
			...
			// close tag
			$this->add(call_user_func_array([\Kwerqy\Ember\com\ui\ui::make()->tag(), "_{$current_tag}"], []));
		}
