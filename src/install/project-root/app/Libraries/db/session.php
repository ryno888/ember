 ...
 * @author Ryno Van Zyl
 */
class session extends \Kwerqy\Ember\com\db\intf\table {
	//--------------------------------------------------------------------------------
	// properties
	//--------------------------------------------------------------------------------
	public string $name = "session";
	public string $key = "ses_id";
	public string $display = "ses_id";

	public string $display_name = "Session";

	public array $field_arr = array( // FIELDNAME => DISPLAY[0] DEFAULT[1] TYPE[2] REFERENCE[3]
		"ses_id"			        => array("Id"		            , "null"    , TYPE_KEY, ),
        ...
        "ses_ref_person_as"	        => array("Ref Person As"        , "null"    , TYPE_INT, "person"),
        "ses_ref_person_active"	    => array("Ref Person Active"    , "null"    , TYPE_INT, "person"),
        "ses_ref_acl_role"			=> array("Ref Acl Role"		    , "null"    , TYPE_INT, "acl_role"),
        "ses_ref_acl_role_active"   => array("Ref Acl Role Active"  , "null"    , TYPE_INT, "acl_role"),
